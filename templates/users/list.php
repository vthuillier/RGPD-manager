<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-slate-800">Utilisateurs de l'organisation</h1>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <?php if ($user->id !== (int) $_SESSION['user_id']): ?>
                            <form action="index.php?page=user&action=delete" method="POST" class="inline"
                                ...
                                <button type="submit" class="text-red-600 hover:text-red-900 ml-3">Supprimer</button>
                            </form>
                        <?php endif; ?>
                    </td>
                </tr>
